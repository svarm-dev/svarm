...
### Primary
- **Soft Moss** (`oklch(58% 0.08 152)` light / `oklch(72% 0.09 152)` dark): Primary buttons, selection rings, running pulse. White/near-white text on fills in light mode.
...
### Navigation
- Top bar: swarm logo + Svärm wordmark; Board / Approvals ghost; theme toggle
