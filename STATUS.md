...
|-------|--------|
| **Updated** | 2026-08-13 |
| **`main`** | (this PR) typed stream Events/RunLog projection (#110) |
| **Latest tag** | **v0.1.3** (2026-08-02) |
| **Unreleased** | Run console, CI resume, skills inject, sample pack, toolchain preflight, typed stream projection — see CHANGELOG |
| **Focus** | **[#111](https://github.com/svarm-dev/svarm/issues/111)** — typed stream: BoardLive chrome + restore tests |
